    ...
    <div class="pt-5 pt-lg-8 pl-md-5 pl-lg-9 space-bottom-2 space-bottom-lg-3 mb-xl-1">
        ...
        <div class="mb-4">
            <p class="mb-0 font-size-2 ml-lg-1 text-gray-600">From your account dashboard you can view your <span
                    class="text-dark">recent orders,</span> manage your <span class="text-dark">shipping and billing addresses,</span>
                and edit your <span class="text-dark">password and account details.</span></p>
        </div>
        <div class="row no-gutters row-cols-1 row-cols-md-2 row-cols-lg-3">
            <div class="col">
                <div class="border py-6 text-center">
                    <a href="orders" class="btn btn-primary rounded-circle px-4 mb-2">
            ...
            <div class="col">
                <div class="border border-left-0 py-6 text-center">
                    <a href="downloads" class="btn bg-gray-200 rounded-circle px-4 mb-2">
            ...
            <div class="col">
                <div class="border border-left-0 py-6 text-center">
                    <a href="userProfile" class="btn bg-gray-200 rounded-circle px-4 mb-2">
            ...
            <div class="col">
                <div class="border py-6 text-center">
                    <a href="wishlist" class="btn bg-gray-200  rounded-circle px-4 mb-2">
