            ...
            <div class="container pt-3 pt-md-4 pb-3 pb-md-5">
                <div class="d-flex align-items-center position-relative flex-wrap">
                    ...
                    <div class="site-branding pr-7">
                        <a href="/ebookstore/" class="d-block mb-2">
                            ...
                            <%--                                <path class="fill-primary-green" fill-rule="evenodd"--%>
                            <%--                                      d="M105.996,23.500 C105.995,26.752 103.950,29.265 100.748,29.950 C100.713,29.958 100.681,29.984 100.647,30.000 C100.588,30.000 100.529,30.000 100.471,30.000 C100.467,28.585 100.460,27.171 100.466,25.756 C100.467,25.675 100.550,25.566 100.626,25.518 C101.352,25.068 101.714,24.426 101.711,23.571 C101.707,22.020 101.710,20.469 101.710,18.892 C103.133,18.892 104.546,18.892 105.996,18.892 C105.996,18.989 105.996,19.093 105.996,19.196 C105.996,20.631 105.997,22.065 105.996,23.500 ZM101.715,17.089 C101.715,15.991 101.683,14.917 101.723,13.847 C101.767,12.680 102.761,11.806 103.931,11.838 C105.060,11.869 105.978,12.794 105.992,13.941 C106.005,14.954 105.995,15.969 105.995,16.984 C105.995,17.012 105.987,17.040 105.980,17.089 C104.569,17.089 103.157,17.089 101.715,17.089 ZM96.421,29.234 C94.322,27.984 93.199,26.136 93.155,23.704 C93.108,21.138 93.145,18.571 93.146,16.004 C93.146,15.957 93.153,15.910 93.159,15.841 C94.572,15.841 95.976,15.841 97.426,15.841 C97.426,15.948 97.426,16.060 97.426,16.172 C97.426,18.602 97.430,21.031 97.423,23.461 C97.421,24.364 97.757,25.066 98.548,25.540 C98.629,25.589 98.688,25.740 98.689,25.844 C98.699,27.123 98.695,28.401 98.696,29.679 C98.696,29.786 98.703,29.894 98.707,30.000 C98.648,30.000 98.590,30.000 98.531,30.000 C97.799,29.823 97.075,29.624 96.421,29.234 ZM93.145,14.044 C93.145,13.935 93.145,13.823 93.145,13.711 C93.145,11.318 93.137,8.926 93.149,6.534 C93.154,5.625 92.817,4.928 92.023,4.460 C91.961,4.424 91.894,4.332 91.894,4.265 C91.886,2.850 91.888,1.436 91.888,0.000 C93.423,0.232 94.703,0.890 95.731,2.009 C96.833,3.209 97.413,4.630 97.421,6.262 C97.433,8.791 97.426,11.320 97.427,13.848 C97.427,13.906 97.421,13.965 97.416,14.044 C96.005,14.044 94.599,14.044 93.145,14.044 ZM89.588,4.782 C89.033,5.128 88.866,5.768 88.868,6.431 C88.875,8.062 88.870,9.692 88.869,11.322 C88.869,12.143 88.869,12.963 88.867,13.784 C88.867,13.869 88.857,13.954 88.851,14.051 C87.433,14.051 86.035,14.051 84.587,14.051 C84.587,13.958 84.587,13.866 84.587,13.774 C84.588,11.294 84.579,8.814 84.590,6.334 C84.605,3.158 86.853,0.543 90.000,0.018 C90.028,0.013 90.058,0.017 90.125,0.017 C90.125,0.639 90.125,1.243 90.125,1.848 C90.125,2.405 90.109,2.962 90.130,3.518 C90.149,4.032 90.126,4.447 89.588,4.782 ZM84.585,15.837 C86.015,15.837 87.420,15.837 88.868,15.837 C88.868,15.951 88.868,16.065 88.868,16.179 C88.868,18.609 88.849,21.039 88.873,23.468 C88.908,27.007 86.358,29.493 83.589,29.955 C83.552,29.961 83.518,29.985 83.482,30.000 C83.423,30.000 83.365,30.000 83.306,30.000 C83.310,28.634 83.319,27.269 83.312,25.902 C83.311,25.691 83.376,25.580 83.559,25.467 C84.268,25.030 84.587,24.371 84.587,23.549 C84.587,21.100 84.586,18.650 84.585,16.201 C84.585,16.085 84.585,15.970 84.585,15.837 ZM81.366,30.000 C80.875,29.844 80.360,29.740 79.897,29.524 C77.435,28.381 76.120,26.441 76.027,23.732 C75.974,22.192 76.017,20.649 76.016,19.107 C76.016,19.041 76.016,18.973 76.016,18.886 C77.447,18.886 78.859,18.886 80.303,18.886 C80.303,19.000 80.303,19.105 80.303,19.209 C80.303,20.663 80.308,22.117 80.302,23.571 C80.298,24.427 80.666,25.065 81.387,25.518 C81.463,25.566 81.547,25.675 81.547,25.756 C81.553,27.171 81.546,28.585 81.542,30.000 C81.484,30.000 81.425,30.000 81.366,30.000 ZM76.017,17.097 C76.017,16.540 76.017,15.997 76.017,15.453 C76.017,14.966 76.012,14.478 76.017,13.991 C76.030,12.831 76.911,11.892 78.032,11.838 C79.203,11.781 80.217,12.619 80.281,13.798 C80.341,14.885 80.294,15.978 80.294,17.097 C78.857,17.097 77.452,17.097 76.017,17.097 Z"/>--%>
                            <%--                            </svg>--%>
                            <span class="font-size-5 d-flex pt-3">

                            </span>
                            <span class="font-size-5 d-flex pt-3 text-white "><img src="assets/img/favicon.png" class=""
                                                                                   style="width: 50px; margin-top: -10px;">eBookStore</span>
                        </a>
                    </div>
                        ...
                        <form class="form-inline my-2 my-xl-0">
                            <div class="input-group input-group-borderless w-100">
                                <div class="input-group-prepend mr-0 d-none d-xl-block">
                                    <select class="custom-select pr-7 pl-4 rounded-right-0 height-5 shadow-none border-0 text-dark"
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-primary-green px-3 py-2" type="submit"><i
                                            class="mx-1 glph-icon flaticon-loupe text-white"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
                           ...
                           data-unfold-duration="500">
                            <div class="d-flex align-items-center text-white font-size-2 text-lh-sm">
                                ...
                                <div class="ml-2 d-none d-lg-block">
                                    <span class="text-secondary-gray-1080 font-size-1">Sign In</span><br>
                                    <span class="font-size-2 text-red-1">Thabith</span>
                                </div>
                            </div>
                        </a>
        ...
        <div class="bg-secondary-black-200 d-none d-md-block">
            <div class="container">
                <div class="d-flex align-items-center justify-content-center position-relative">
                    <div class="site-navigation mr-auto d-xl-block">
                        <ul class="nav">
                            <li class="nav-item dropdown">
                                ...
                                <ul id="homeDropdownMenu"
                                    ...
                                    <li><a href="home" class="dropdown-item link-black-100">Home</a></li>
                                    <li>
                                        <a href="shop"
                                           class="dropdown-item link-black-100">Shop List</a></li>
                                    <li>
                                    <li>
                                        <a href=""
                                           class="dropdown-item link-black-100">Single Product</a></li>
                                    <li>
                                    <li>
                                        <a href="cart"
                            ...
                            <li class="nav-item"><a href="#"
                                                    class="nav-link link-black-100 mx-3 px-0 py-3 font-size-2 font-weight-medium">Categories</a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul id="shopDropdownMenu"
                                    ...
                                    <li>
                                        <a href="dashboard"
                                           class="dropdown-item link-black-100">Dashboard</a></li>
                                    <li>
                                    <li>
                                        <a href="orders"
                                           class="dropdown-item link-black-100">Orders</a></li>
                                    <li>
                                    <li>
                                        <a href="downloads"
                                           class="dropdown-item link-black-100">Downloads</a></li>
                                    <li>
                                        <a href="UserProfile"
                                           class="dropdown-item link-black-100">Account Details</a></li>
                                    <li>
                                        <a href="wishlist"
                                           class="dropdown-item link-black-100">Wishlist</a></li>
                                    <li>
                                        <a href=""
                                           class="dropdown-item link-black-100">Logout</a></li>
                                </ul>
                            </li>
...
Remember me
                                    ...
                                    <div class="mb-4d75">
                                        <button type="submit" class="btn btn-block py-3 rounded-0 btn-dark">Sign In
                                        </button>
                                    </div>
                                    <div class="mb-2">
                                        <a href="javascript:;"
                                           class="js-animation-link btn btn-block py-3 rounded-0 btn-outline-dark font-weight-medium"
                                           data-target="#signup" data-link-group="idForm" data-animation-in="fadeIn">Create
                                            Account</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                                ...
                                <div class="p-4 p-md-6">
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="js-form-message js-focus-state">
                                            <label id="signinPasswordLabel1" class="form-label" for="signinPassword1">Password
                                                *</label>
                                            <input type="password" class="form-control rounded-0 height-4 px-4"
                            ...
                            <div class="media">
                                ...
                                <div class="media-body ml-4d875">
                                    ...
                                    <h2 class="woocommerce-loop-product__title h6 text-lh-md mb-1 text-height-2 crop-text-2">
                                        <a href="#" class="text-dark">The Ride of a Lifetime: Lessons Learned from 15
                                            Years as CEO</a>
                                    </h2>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body ml-4d875">
                                    <div class="text-primary text-uppercase font-size-1 mb-1 text-truncate"><a href="#">Hard
                                        Cover</a></div>
                                    <h2 class="woocommerce-loop-product__title h6 text-lh-md mb-1 text-height-2 crop-text-2">
                                        <a href="#" class="text-dark">The Rural Diaries: Love, Livestock, and Big Life
                                            Lessons Down</a>
                                    </h2>
                                    <div class="font-size-2 mb-1 text-truncate"><a href="#" class="text-gray-700">Hillary
                                        Burton</a></div>
                                    <div class="price d-flex align-items-center font-weight-medium font-size-3">
                        ...
                        <div class="px-4 py-5 px-md-6 border-bottom">
                            <div class="media">
                                ...
                                <div class="media-body ml-4d875">
                                    ...
                                    <h2 class="woocommerce-loop-product__title h6 text-lh-md mb-1 text-height-2 crop-text-2">
                                        <a href="#" class="text-dark">Russians Among Us: Sleeper Cells, Ghost Stories,
                                            and the Hunt.</a>
                                    </h2>
