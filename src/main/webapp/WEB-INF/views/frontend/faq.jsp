                                    ...
                                    <div class="card rounded-0 border-0">
                                        ...
                                        <div id="basicsCollapseOne" class="collapse show" aria-labelledby="basicsHeadingOne"
                                            ...
                                            <div class="card-body p-3 p-md-4">
                                                <div class="mx-md-1">
                                                    <p class="mb-4 pb-1 font-size-2">A placerat ac vestibulum integer vehicula
                                                        suspendisse nostra aptent fermentum tempor a magna erat ligula
                                                        parturient curae sem conubia vestibulum ac inceptos sodales condimentum
                                                        cursus nunc mi consectetur
                                                        condimentum.
                                                    </p>
                                ...
                                <div id="basicsAccordion1">
                                    ...
                                    <div class="card rounded-0 border-0">
                                        <div class="card-collapse card-header p-0 bg-transparent border-bottom-0"
                                            ...
                                            <button type="button"
                                                    ...
                                                    aria-expanded="true" aria-controls="basicsCollapseFive">
                                        ...
                                        <div id="basicsCollapseFive" class="collapse show" aria-labelledby="basicsHeadingFive"
                                    ...
                                    <div class="card rounded-0 border-0 ">
                                        <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                            ...
                                            <h5 class="mb-0">
                                                <button type="button"
                                                        class="collapse-link btn btn-block d-flex align-items-center justify-content-between card-btn py-3 px-0 px-md-4 border rounded-0 shadow-none mt-minus-1"
                                                        data-toggle="collapse" data-target="#basicsCollapseSix"
                                                        aria-expanded="false"
                                    ...
                                    <div class="card rounded-0 border-0">
                                        <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                            ...
                                            <button type="button"
                                                    class="collapse-link btn btn-block d-flex align-items-center justify-content-between card-btn py-3 px-0 px-md-4 border rounded-0 shadow-none mt-minus-1"
                                                    data-toggle="collapse" data-target="#basicsCollapseSeven"
                                                    aria-expanded="false"
                                    ...
                                    <div class="card rounded-0 border-0">
                                        <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                            ...
                                            <button type="button"
                                                    class="collapse-link btn btn-block d-flex align-items-center justify-content-between card-btn py-3 px-0 px-md-4 border rounded-0 shadow-none mt-minus-1"
                                                    data-toggle="collapse" data-target="#basicsCollapseEight"
                                                    aria-expanded="false"
                                    ...
                                    <div class="card rounded-0 border-0">
                                        <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                            ...
                                            <button type="button"
                                                    class="collapse-link btn btn-block d-flex align-items-center justify-content-between card-btn py-3 px-0 px-md-4 border rounded-0 shadow-none mt-minus-1"
                                                    data-toggle="collapse" data-target="#basicsCollapseNine"
                                                    aria-expanded="false"
