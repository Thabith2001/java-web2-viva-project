...
<layout:extends name="base">
    <layout:put block="title">
        <title>My Account | eBookStore</title>
    </layout:put>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <!----------------------Dashboard--------------------------->
                            <!-- my-account-dashboard is already edited to add to this -->
                                    ...
                                    <table class="table mb-0">
                                            ...
                                            <th class="pl-3 pl-md-5 font-weight-normal align-middle py-6">
                                                <div class="d-flex align-items-center">
                                                    <a class="d-block" href="#">
                                                        <img class="img-fluid" src="assets/img/90x138/img1.jpg"
                                        ...
                                        <tr class="border">
                                            <th class="pl-3 pl-md-5 font-weight-normal align-middle py-6">
                                                <div class="d-flex align-items-center">
                                                    <a class="d-block" href="#">
                                                        <img class="img-fluid" src="assets/img/90x138/img3.jpg"
                                                             alt="Image-Description">
                                                    </a>
                                                    <div class="ml-xl-4">
                                                        <div class="font-weight-normal">
                                        ...
                                        <tr class="border">
                                            <th class="pl-5 font-weight-normal align-middle py-6">
                                                <div class="d-flex align-items-center">
                                                    <a class="d-block" href="#">
                                                        <img class="img-fluid" src="assets/img/90x138/img4.jpg"
                                                             alt="Image-Description">
                                                    </a>
                                                    <div class="ml-xl-4">
                                                        <div class="font-weight-normal">
